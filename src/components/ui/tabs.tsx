...
export const TabsTrigger: React.FC<{ value: string; children: React.ReactNode; onClick?: () => void }> = ({
  children,
  onClick,
}) => (
  <button onClick={onClick} className="px-3 py-1 rounded-md bg-gray-200 hover:bg-gray-300">
    {children}
  </button>
);
